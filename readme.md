...
[![Build Status](https://travis-ci.com//wp-social-media.svg?branch=master)](https://travis-ci.com//wp-social-media)
[![Coverage Status](https://coveralls.io/repos/github//wp-social-media/badge.svg?branch=master)](https://coveralls.io/github//wp-social-media?branch=master)
...
which will make it available at [wp-social-media.local](http://wp-social-media.local).
...
Visit [wp-social-media.local:8025](http://wp-social-media.local:8025) to check all emails sent by WordPress.
